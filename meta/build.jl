...
#AppBundler.build_app(MacOS(:aarch64), APP_DIR, "$BUILD_DIR/peacefounder-$VERSION-arm64.dmg"; incremental=false)

#AppBundler.build_app(MacOS(:aarch64), APP_DIR, "$BUILD_DIR/peacefounder-$VERSION-arm64.app"; incremental=true)
...
AppBundler.build_app(Windows(:x86_64), APP_DIR, joinpath(homedir(), "Documents", "peacefounder-$VERSION-x64-win.msix"); path_length_threshold = 180, skip_long_paths = true, precompile=true)
